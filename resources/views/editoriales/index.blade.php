...
@section('title', @$editorial->nombreEditorial)

@section('content')

{{-- cards novedades EDITORIAL --}}

<div class="novedades mt-3  pt-2 pb-2  ">
    <div class="d-flex justify-content-center">
      <h1>NOVEDADES {{$editorial->nombreEditorial}}</h1>          
    </div>
    <hr class="mb-3">
    <div class="carousel_comics ">
        @php
          ...
          $comics = Producto::where('EDITORIAL', $editorial->ID)->orderBy('FECHA_LLEGADA', 'desc')->limit(12)->get();
        @endphp 
